<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/www/wwwroot/hgqlgzsl.temdu.com/public/../application/admin/view/tablemake/edit.html";i:1573124625;s:74:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/layout/default.html";i:1572536367;s:71:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/common/meta.html";i:1572536366;s:73:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/common/script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
	...
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-8">
			<input id="c-table" data-rule="required" disabled="disabled" readonly="readonly" class="form-control form-control" name="row[table]" type="text" value="<?php echo $prefix; ?><?php echo $row['table']; ?>">
		</div>
