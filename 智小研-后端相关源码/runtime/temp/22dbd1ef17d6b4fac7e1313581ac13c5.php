<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/www/wwwroot/hgqlgzsl.temdu.com/public/../application/admin/view/download/add.html";i:1573283902;s:74:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/layout/default.html";i:1572536367;s:71:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/common/meta.html";i:1572536366;s:73:"/www/wwwroot/hgqlgzsl.temdu.com/application/admin/view/common/script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-kmm" data-rule="required" class="form-control" name="row[kmm]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Zlm'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-zlm" data-rule="required" class="form-control" name="row[zlm]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-ljfile" data-rule="required" class="form-control" size="50" name="row[ljfile]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-xzcs" data-rule="required" class="form-control" name="row[xzcs]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-dx" data-rule="required" class="form-control" name="row[dx]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Gs'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-gs" data-rule="required" class="form-control" name="row[gs]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Ms'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ms" data-rule="required" class="form-control" name="row[ms]" type="text" value="">
        </div>
    </div>
